           ...
           new Product()
           {
            ...
            modelBuilder.Entity<ProductTranslation>().HasData(
                 new ProductTranslation()
                 {
                     Id = 1,
                     ProductId = 1,
                     Name = "Áo sơ mi nam trắng Yame",
                     LanguageId = "vi-VN",
                     SeoAlias = "ao-so-mi-nam-trang-yame",
                     SeoDescription = "Áo sơ mi nam trắng Yame",
                     SeoTitle = "Áo sơ mi nam trắng Yame",
                     Details = "Áo sơ mi nam trắng Yame",
                     Description = "Áo sơ mi nam trắng Yame"
                 },
                    new ProductTranslation()
                    {
                        Id = 2,
                        ProductId = 1,
                        Name = "Yame Men T-Shirt",
                        LanguageId = "en-US",
                        SeoAlias = "yame-men-t-shirt",
                        SeoDescription = "Yame Men T-Shirt",
                        SeoTitle = "Yame Men T-Shirt",
                        Details = "Yame Men T-Shirt",
                        Description = "Yame Men T-Shirt"
                    });
